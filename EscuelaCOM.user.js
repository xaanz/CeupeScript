// ==UserScript==
// @name         A quien le paso la tutoria
// @version      1.5
...
(function() {
    ...
    [
      ...
      "SUBASTAS JUDICIALES", "ASESORAMIENTO FINANCIERO", "BANCA Y SEGUROS", "BOLSA",
      ...
      "PSICOLOGÍA SOCIAL", "PSICOTERAPIA", "SEXOLOGÍA, TERAPIA FAMILIAR Y DE PAREJA"
    ].forEach(e => coordinadores[e] = "Clara");
    ...
    [
      ...
      "TRANSPORTE Y MANTENIMIENTO DE VEHÍCULOS", "AJEDREZ", "ARTES MARCIALES",
      "BAILE", "BALONCESTO", "BALONMANO", "BICICLETA Y CICLISMO", "BUCEO", "CAZA",
    ...
    [
      ...
      "DISEÑO INDUSTRIAL", "INGENIERÍA AERONÁUTICA", "INGENIERÍA CIVIL", "INGENIERÍA DEL MANTENIMIENTO",
    ...
    [
      ...
      "IGUALDAD Y VIOLENCIA DE GÉNERO", "INTERVENCIÓN SOCIAL", "MEDIACIÓN SOCIAL", "COACHING NUTRICIONAL",
