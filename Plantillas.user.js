...
4- Le llegará un email para confirmar el correo. En caso de no recibirlo, comprueba spam o correo no deseado. Si aun asi no recibió el correo de confirmación, entre a esta página para recibirlo de nuevo: <a href="${datos.userConfirm}" target="_blank">${datos.userConfirm}</a>.
